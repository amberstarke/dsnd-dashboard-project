...
class ReportDropdown(Dropdown):
    ...
    def build_component(self, model, selected=None):
        ...
        return super().build_component(model, selected)
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, asset_id, model):
        ...
        predict_proba = self.predictor.predict_proba(model_data)[:, 1]
        
        # Index the second column of predict_proba output
        # The shape should be (<number of records>, 1)
        #### YOUR CODE HERE

        # The code above does the indexing, so nothing is needed here.
